<h2><a href="https://www.geeksforgeeks.org/problems/decrement-array-values/1?page=3&category=CPP&sortBy=submissions">Decrement Array Values</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an array <strong>arr[] </strong>that contains integers. You need to decrement each element of the array by&nbsp;1 and return the array.</span></p>
