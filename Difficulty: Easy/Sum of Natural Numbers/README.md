<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-n-number--144226/1?page=4&category=CPP&sortBy=submissions">Sum of Natural Numbers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given an integer <strong>n</strong>, compute the sum of all natural numbers from 1 to n (inclusive). If n is 0, the sum should be 0.</span></p>
